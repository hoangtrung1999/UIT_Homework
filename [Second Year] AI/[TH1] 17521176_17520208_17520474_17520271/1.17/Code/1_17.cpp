...
void Output(vector<int>, int, vector<string>);
void Output(vector<vector<int>>);
void Output(vector<int>);

int main()
{
	vector<string> Province = { "Ca Mau", "Bac Lieu" , "Kien Giang", "Soc Trang", "Hau Giang", "Can Tho", "An Giang", "Tra Vinh", "Vinh Long", "Dong Thap", "Ben Tre", "Tien Giang", "Long An" };
...
void Output(vector<int> Colour, int n, vector<string> str)
{
	for (int i = 0; i < n; ++i)
		cout << str[i] << ": \t" << Colour[i] << endl;
}